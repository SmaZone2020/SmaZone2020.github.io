  ...
  return (
    <>
      <aside
        ...
        ${collapsed ? 'w-18' : 'w-54'}`}
      >
        <div className="h-auto bg-white/40 dark:bg-surface/60 backdrop-blur-sm rounded-[32px] p-4 py-6">
          <div className="flex flex-col h-full">
            ...
            <div className="space-y-4">
              ...
              <motion.div
                layout
                className="pt-4 border-t border-gray-200 dark:border-gray-800 w-ful"
              >
